...
class ConfirmConfigPopUp(Toplevel):
    ...
    __on_manual_config: 'function'

    def __init__(self, parent, on_confirm, on_cancel, on_manual_config):
        super().__init__(parent)
        self.wm_title("Configuration confirmation")
    ...
    def show(self, dataset: DataSet):
        ...
        if button_pressed.get() == "cancel":
            ...
            self.__on_manual_config(dataset)
        else:
            self.__on_confirm()
